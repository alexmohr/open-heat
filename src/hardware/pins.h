...
#define PIN_D0                                                                           \
  16 // Pin D0 mapped to pin GPIO16/USER/WAKE of ESP8266. This pin is also used for
...
#define PIN_LED                                                                          \
  2 // Pin D4 mapped to pin GPIO2/TXD1 of ESP8266, NodeMCU and WeMoS, control on-board LED
#define PIN_D5 14 // Pin D5 mapped to pin GPIO14/HSCLK of ESP8266
#define PIN_D6 12 // Pin D6 mapped to pin GPIO12/HMISO of ESP8266
#define PIN_D7 13 // Pin D7 mapped to pin GPIO13/RXD2/HMOSI of ESP8266
#define PIN_D8 15 // Pin D8 mapped to pin GPIO15/TXD2/HCS of ESP8266

// Don't use pins GPIO6 to GPIO11 as already connected to flash, etc. Use them can crash
// the program GPIO9(D11/SD2) and GPIO11 can be used only if flash in DIO mode ( not the
// default QIO mode)
